...
public class CheeseRepo {
    ...
    public Cheese update(int cheeseIndex, Cheese updateCheeseDTO){
        ...
        cheese.type = updateCheeseDTO.type;
        return cheese;
    }
}
```
...
package com.datorium.Datorium.API.Contollers;
import com.datorium.Datorium.API.DTOs.Cheese;
...
```
![image](https://github.com/user-attachments/assets/bed0c74e-3e5c-4263-abfb-db9cd947ace6)
![image](https://github.com/user-attachments/assets/e4593042-49b9-42d3-b5c3-dc7e7cedd73f)
![image](https://github.com/user-attachments/assets/a0467feb-7423-49d9-8a9e-0e7130a9c6ba)
